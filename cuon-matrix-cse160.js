...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        // hard-coded for Vector3, although i'm sure there is some way to do it irrespective of vector size
        let v3x = (v[1] * w[2]) - (v[2] * w[1]);
        let v3y = (v[2] * w[0]) - (v[0] * w[2]);
        let v3z = (v[0] * w[1]) - (v[1] * w[0]);
    ...
    magnitude() {
        ...
        var sum = 0;
        for (i = 0; i < 3; ++i) {
          sum = sum + (this.elements[i] * this.elements[i]);
        }
    ...
    normalize() {
        ...
        for (i = 0; i < 3; ++i) {
          this.elements[i] = this.elements[i]/mg;
        }
